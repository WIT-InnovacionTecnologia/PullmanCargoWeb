                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <ScrollReveal animation="slide-in-right" className="bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
                        <div className="space-y-6 text-center lg:text-left">
                            <h3 className="text-xl font-bold text-[#ff5500]">Rastreador de Guía</h3>
                            <p className="text-sm text-white/70">
                                Ingresa el número de guía que aparece en tu comprobante de envío.
                            </p>
                            <form className="flex flex-col sm:flex-row gap-3">
                                <Input
                                    className="h-12 bg-white text-black border-0 focus-visible:ring-[#ff5500]"
                                    placeholder="Ej: 123456789"
                                    type="text"
                                />
                                <Button className="h-12 bg-[#ff5500] hover:bg-[#e04b00] text-white font-bold px-8 shadow-lg shadow-black/20">
